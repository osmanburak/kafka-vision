...
export const translations = {
  en: {
    ...
    loading: 'Loading...',
    kafkaResponseParseError: 'Kafka client could not parse the broker response (transient).',
    refresh: 'Refresh',
  ...
  tr: {
    ...
    testCancelled: 'Test iptal edildi',
    testTimeout: 'Bağlantı zaman aşımına uğradı',
    connect: 'Bağlan',
    ...
    loading: 'Yükleniyor...',
    kafkaResponseParseError: 'Kafka istemcisi broker yanıtını ayrıştıramadı (geçici bir hata).',
    refresh: 'Yenile',
